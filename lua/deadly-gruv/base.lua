...
local M = lush(function()
  return {
    ...
    DiffText     { bg = sp.highly_contrasting[7].main, gui = 'bold' }, -- Diff mode: Changed text within a changed line |diff.txt|
    ...
    Error          { gui = 'undercurl', guisp = sp.error }, -- Any erroneous construct
